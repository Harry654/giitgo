...
function UserInfo() {
  ...
  return (
    <Popup
      trigger={
        <div className="w-96 flex items-center justify-center cursor-pointer hover:scale-125 transition">
    ...
    >
      <div
        className="h-full gap-10 text-center p-4 flex flex-col"
        style={{
          background:
            "linear-gradient(to top left, transparent 60%, rgb(0, 50, 0), transparent",
        }}
      >
        <div className="w-full flex items-center gap-10">
          ...
          <div className="flex flex-col items-start w-1/2">
            ...
            {user.bio && <p className="text-gray-500 text-left">{user.bio}</p>}
            <div className="flex items-center mt-3">
              <p className="text-gray-500 text-left">
                {user.followers} followers
              </p>
              <BsDot size={20} color="#fff" />
              <p className="text-gray-500 text-left">
